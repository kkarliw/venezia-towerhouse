...
import planoTipologiaD2 from "/images/planta-tipo-d2.png";
const TipologiaD2 = () => {
  const tipologia = {
    id: "d2",
    name: "Tipología D2",
    subtitle: "Espacios Familiares",
    price: "$688.800.000",
    currency: "COP",
    status: "Disponible",
    size: "84",
    rooms: "2",
    bathrooms: "2",
    description: "Hermosa tipología D2 que ofrece un diseño espacioso y bien distribuido, ideal para familias que buscan comodidad y estilo. Disfruta de amplias áreas sociales, habitaciones confortables y acabados de lujo en cada rincón. Además, cuenta con la opción de un jacuzzi en el balcón para momentos de relajación únicos.",
    images: [
    ...
    features: [
      ...
      "Cuarto de lavado",
      "Balcones de 24,7 m² con jacuzzi (Compra adicional)",
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-6">Acabados de Lujo</h2>
              <ul className="space-y-3">
