...
const planoTipologiaD2 = "/images/planta-tipo-d2.png";
...
const TipologiaD2 = () => {
  ...
  const tipologia = {
    id: "d2",
    name: t("tipologiaDetail.tipologiaD2.name"),
    subtitle: t("tipologiaDetail.tipologiaD2.subtitle"),
    price: "$688.800.000",
    status: t("tipologiaDetail.tipologiaD2.status"),
    size: "84",
    rooms: "2",
    bathrooms: "2",
    description: t("tipologiaDetail.tipologiaD2.description"),
    images: [
  ...
  const features = [
    t("tipologiaDetail.tipologiaD2.features.0"),
    t("tipologiaDetail.tipologiaD2.features.1"),
    t("tipologiaDetail.tipologiaD2.features.2"),
    t("tipologiaDetail.tipologiaD2.features.3"),
    t("tipologiaDetail.tipologiaD2.features.4"),
    t("tipologiaDetail.tipologiaD2.features.5"),
    t("tipologiaDetail.tipologiaD2.features.6"),
    t("tipologiaDetail.tipologiaD2.features.7"),
  ];

  const finishes = [
    t("tipologiaDetail.tipologiaD2.finishes.0"),
    t("tipologiaDetail.tipologiaD2.finishes.1"),
    t("tipologiaDetail.tipologiaD2.finishes.2"),
    t("tipologiaDetail.tipologiaD2.finishes.3"),
    t("tipologiaDetail.tipologiaD2.finishes.4"),
    t("tipologiaDetail.tipologiaD2.finishes.5"),
  ];
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-foreground mb-6">{t("tipologiaDetail.descripcion")}</h2>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-6">{t("tipologiaDetail.caracteristicas")}</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-6">{t("tipologiaDetail.acabadosLujo")}</h2>
              <ul className="space-y-3">
