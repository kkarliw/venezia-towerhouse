...
const planoTipologiaD1 = "/images/planta-tipo-d1.png";
...
const TipologiaD1 = () => {
  ...
  const tipologia = {
    id: "d1",
    name: t("tipologiaDetail.tipologiaD1.name"),
    subtitle: t("tipologiaDetail.tipologiaD1.subtitle"),
    price: "$636.660.000",
    status: t("tipologiaDetail.tipologiaD1.status"),
    size: "78,6",
    rooms: "2",
    bathrooms: "2",
    description: t("tipologiaDetail.tipologiaD1.description"),
    images: [
      "/images/sala23.jpg",
  ...
  const features = [
    t("tipologiaDetail.tipologiaD1.features.0"),
    t("tipologiaDetail.tipologiaD1.features.1"),
    t("tipologiaDetail.tipologiaD1.features.2"),
    t("tipologiaDetail.tipologiaD1.features.3"),
    t("tipologiaDetail.tipologiaD1.features.4"),
    t("tipologiaDetail.tipologiaD1.features.5"),
    t("tipologiaDetail.tipologiaD1.features.6"),
    t("tipologiaDetail.tipologiaD1.features.7"),
  ];

  const finishes = [
    t("tipologiaDetail.tipologiaD1.finishes.0"),
    t("tipologiaDetail.tipologiaD1.finishes.1"),
    t("tipologiaDetail.tipologiaD1.finishes.2"),
    t("tipologiaDetail.tipologiaD1.finishes.3"),
    t("tipologiaDetail.tipologiaD1.finishes.4"),
    t("tipologiaDetail.tipologiaD1.finishes.5"),
  ];
